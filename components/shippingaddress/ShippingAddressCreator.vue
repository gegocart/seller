<template>
  <div id="app">
   ...
   <div v-if="this.success!=null" class="w-1/2 my-4 bg-green-light p-4" id="success-alert"><p class="text-white">{{this.success}}</p></div>
 <!--   <div v-if="this.success!=null" class="w-1/2 my-4 bg-red-light p-4" id="success-alert"><p class="text-white">{{this.success}}</p></div> -->
  ...
  <div class="w-full" v-show="addaddress">
              <h4 class="mb-4 mt-4 uppercase">Add Shipping Address</h4>
          ...
          <div class="flex my-2">
              <div class="w-1/2 field mr-2 flex">
                ...
                <div class="control flex flex-col w-3/5">
                 <input class="input" type="text" placeholder="firstname" v-model="form.firstname">
                </div>
              ...
              <div class="w-1/2 field flex">
                ...
                <div class="control flex flex-col w-3/5">
                 <input class="input" type="text" placeholder="lastname" v-model="form.lastname">
                </div>
             ...
             <div class="flex my-2">
              ...
              <div class="w-1/2 field flex">
                ...
                <div class="control flex flex-col w-3/5">
                 <input class="input" type="text" placeholder="mobileno" v-model="form.mobileno">
                </div>
            ...
            <div class="w-1/2 field my-2 flex">
              ...
              <div class="control flex flex-col w-3/5">
               <!--  <textarea class="input-type my-2" v-model="form.address_1"></textarea> -->
                 <input class="input my-2" type="text" placeholder="address_1" v-model="form.address_1">
                  <input class="input my-2" type="text" placeholder="address_2" v-model="form.address_2">
              </div>
          ...
          <div class="flex my-2">
            <div class="w-1/2 field my-2 flex">
              ...
              <div class="control flex flex-col w-3/5">
                <input class="input" type="number"  placeholder="6 digit (0 to 9)" v-model="form.postal_code"> 
              </div>
            ...
            <div class="w-1/2 field my-2 flex items-center">
             ...
             <!--  <div class="control flex flex-col w-6">
                <input class="input" type="checkbox"  v-model="form.default"> 
              </div>
          ...
          <div class="">
            ...
            <div v-for="address in addresses" class="w-1/2  pr-5 my-3  h-full" :key="address.id">
