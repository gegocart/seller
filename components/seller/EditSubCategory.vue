...
<span class="mx-2">
 <a @click="enableform(categoryid)" :to="{name: 'seller-editsubcategory',params:{categoryid:category.id,parentid:category.parent_id}}"  class="" data-toggle="tooltip" title="Edit"><img src="~/assets/img/edit.svg" class="w-4 h-4">
 </a>
 </span>
</p>
</portal>
