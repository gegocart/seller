      ...
      <div class="columns  mb-2 lg:mb-10">
        <div class="field column is-6 flex flex-col lg:flex-row">
          ...
          <div class="control w-full lg:w-3/4">
            <input class="input" type="text" :class="{ 'is-danger': errors.attribute_code }" v-model="attribute.attribute_code"  autofocus="" style="text-transform: lowercase;">
        ...
        <div class="field column is-6 flex flex-col lg:flex-row">
          ...
          <div class="control w-full lg:w-3/4">
            <input class="input" type="text" :class="{ 'is-danger': errors.attribute_label }" v-model="attribute.attribute_label"  autofocus="">
           ...
           <div>     
            ...
            <div>    
              ...
              <div>
               ...
               <div>
                <input type="checkbox" id="validation"  v-model="attribute.validation"  v-on:click="isHidden = !isHidden">
